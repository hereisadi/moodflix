...
const searchsMade = async (req, res) => {
  ...
  try {
    ...
    const fastApiUrl = "http://127.0.0.1:8000/feeling_predictionc";
    // model hosted live on fastapi
    let feelingResponse = "";
    await axios.post(fastApiUrl, { sentence: text }).then((res) => {
      feelingResponse = res.data;
    });
